...
import { deleteProjectSprint, getProjectById, selectSprint, setProject as setCurrentProject, updateProject, updateProjectSprint } from '../../../reducers/project/projectSlice';
...
export default function ManageProject() {
  ...
  const handleSave = async() => {
    try {
      ...
      const updated_project = await dispatch(updateProjectSprint(sprint._id, {
        name: sprint.name,
        ...
        <Grid item xs={6.7}>
          ...
          <Box p={2} display={'flex'} flexDirection={'column'} rowGap={3}>
            ...
            <TextField
              ...
              onChange={e => project.project_name = e.target.value}
              fullWidth
              label="Project Name *"
              variant="outlined"
            />
          ...
          {/* <ManageProjectTasksTable sprint={sprint} tasks={sprint.tasks} /> */}
          <br />
